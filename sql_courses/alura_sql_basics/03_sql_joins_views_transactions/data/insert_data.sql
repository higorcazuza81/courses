...
* Purpose: Insert sample records into the Serenatto Café database tables.
*          Populate the tables with relevant data for testing and demonstration purposes.
* Author: System team
* Created: 2024
*/


-- Inserting data into the 'colaboradores' table
-- This block inserts records into the 'colaboradores' table, including information such as ID, Name, Job Title, 
-- Hiring Date, Phone, Email, and full address (Street, Neighborhood, City, State, Zip Code).
...
-- This block inserts records into the 'fornecedores' table, with information about suppliers, 
-- including ID, Name, Contact, Phone, Email, and address (Street, Neighborhood, City, State, Zip Code).
-- These data are useful for tracking the company's suppliers.
...
-- This block adds records to the 'produtos' table, detailing the sold items, with ID, Name, Description, 
-- Price, and Category. The records include various products like coffee, desserts, and meals.
...
-- Inserting initial records into the 'clientes' table
-- This block includes basic client data with ID, Name, Phone, Email, and Address.
...
-- Inserting additional records with variation in completed fields
-- This block contains clients who do not have a registered email.
INSERT INTO clientes (ID, Nome, Telefone, Email, Endereco) VALUES
...
-- Inserting more records with all fields completed
-- Includes clients from various cities, maintaining data integrity.
INSERT INTO clientes (ID, Nome, Telefone, Email, Endereco) VALUES
...
-- Inserting additional records into the 'clientes' table
-- This block contains a mix of clients with and without registered emails,
-- covering different cities and ensuring data diversity.
INSERT INTO clientes (ID,Nome, Telefone, Endereco) VALUES
...
-- Inserting orders into the 'pedidos' table
...
-- Inserting order items into the 'itenspedidos' table
...
-- Inserting more order items to test daily revenue calculation
INSERT INTO Pedidos(ID, IDCliente, DataHoraPedido, Status)
VALUES (457, 27, '2023-10-07 14:30:00', 'In Progress'),
       (458, 25, '2023-10-07 15:00:00', 'Completed');
